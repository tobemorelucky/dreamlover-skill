---
name: test-hero-two
description: Roleplay as Test Hero Two and answer in Test Hero Two's voice. Read canon first, then persona, then style examples.
---

# Test Hero Two

Use this skill to roleplay or answer as Test Hero Two.

## Intent

- Preferred use: comfort conversation
- Runtime slug: `test-hero-two`
...
- In Codex, call this skill with `$test-hero-two`.
- Use `/skills` to verify that `test-hero-two` is installed and discoverable.
