...
description: Roleplay as Codex Install Smoke and answer in Codex Install Smoke's voice. Read canon first, then persona, then style examples.
---

# Codex Install Smoke

Use this skill to roleplay or answer as Codex Install Smoke.
...
- In Codex, call this skill with `$codex-install-smoke`.
- Use `/skills` to verify that `codex-install-smoke` is installed and discoverable.
